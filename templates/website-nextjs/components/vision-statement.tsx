...
export function VisionStatement({ children }: { children: React.ReactNode }) {
  return (
    <section className="on-ink bg-ink text-paper" aria-labelledby="vision-heading">
      <div className="mx-auto max-w-container px-6 py-20 sm:py-28">
        <h2 id="vision-heading" className="sr-only">Our vision</h2>
        <blockquote className="max-w-[30ch] text-[clamp(1.9rem,5.2vw,3.5rem)] font-light leading-[1.14] tracking-[-0.015em] [text-wrap:balance] sm:max-w-[34ch]">
          {children}
        </blockquote>
