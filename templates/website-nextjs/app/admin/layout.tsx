      ...
      <header className="border-b border-rule">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-6 py-5">
          <div className="flex items-baseline gap-3">
            ...
            <span className="rounded-full bg-teal-ink px-2.5 py-0.5 text-[0.7rem] uppercase tracking-wider text-paper">
              Admin
            </span>
          </div>
          <Link href="/admin/login" className="text-[0.9rem] text-teal-ink no-underline hover:underline">
            Sign out
          </Link>
        </div>
      </header>
      <main id="main" className="flex-1">{children}</main>
      <footer className="border-t border-rule bg-field">
        <p className="mx-auto max-w-6xl px-6 py-4 text-[0.85rem] text-ink/70">
