...
export default function AdminLoginPage() {
  ...
  return (
    <div className="mx-auto grid max-w-sm gap-7 px-6 py-16">
      <div>
        <p className="text-[0.75rem] uppercase tracking-[0.08em] text-accent">Staff access</p>
        <h1 className="mt-2 text-[2rem] leading-tight">Admin sign in</h1>
      ...
      >
        ...
        <button
          type="submit"
          className="mt-1 bg-teal-deep px-4 py-2.5 text-[0.95rem] text-paper hover:opacity-90"
        >
          Sign in
        </button>
      ...
      <p className="text-center">
        <Link
          href="/"
          className="inline-block rounded-full border border-teal px-5 py-2.5 text-[0.9rem] text-accent no-underline hover:bg-mist"
        >
